...
export const USER_PWA_REGISTRATION_UPDATED = SN_USER + '/PWA_REGISTRATION_UPDATED'
export const USER_PWA_UPDATE_STATE_UPDATED = SN_USER + '/PWA_UPDATE_STATE_UPDATED'
